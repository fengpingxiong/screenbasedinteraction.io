...
​
     ...
     const texture = loadTexture.load("textures/grasslight-big.jpg");
​
...
​
  ...
  loader.load( 'mmodels/quinta_da_regaleira_pavilion copy/scene.gltf', gltf => onLoad( gltf, parrotPosition, newStandard), onProgress, onError );
​
  const Position2 = new THREE.Vector3( 7.5, 0, -10 );
  loader.load( 'models/quinta_da_regaleira_pavilion copy/scene.gltf', gltf => onLoad( gltf, Position2, pointsMaterial), onProgress, onError );
​
